...
// Testimonials edit-content (Max 5)
router.post('/testimonials', authMiddleware, contentController.addContentById("Testimonials", 5));
...
// Other Service with Logo edit-content (Max 3)
router.post('/otherService-logo', authMiddleware, contentController.addContentById("Other-Service-Logo", 3));
