...
router.post('/testimonials', authMiddleware, contentController.addTestimonials("Testimonials"));
router.put('/testimonials', authMiddleware, contentController.updateTestimonials("Testimonials"));
...
router.post('/otherService-logo', authMiddleware, contentController.addTestimonials("Other-Service-Logo"));
router.put('/otherService-logo', authMiddleware, contentController.updateTestimonials("Other-Service-Logo"));
